...
??? question "Is this sold as a kit?"
    ...
    Yes — on [booth](https://kazubu.booth.pm/items/8645804).
...
??? question "Where can I buy an SK8707?"
    ...
    From [Sprintek](https://store.sprintek.com/), [Holykeebs](https://holykeebs.com) and similar shops. This mod uses the **SK8707-01-004**.
...
??? question "Are the design files public?"

    The PCB and 3D-printed part data are not published at the moment.
